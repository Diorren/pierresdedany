...
class CartController extends AbstractController
{
     ...
     */
    public function add($id, CartService $cartService, CartRepository $cartRepo, UsersRepository $usersRepo, ProductsRepository $productRepo, EntityManagerInterface $manager)
    {        
        // AJOUT PANIER + CREATION CART + AJOUT EN DB
        ...
        if ($this->getUser()){
            ...
            if(!empty($cartService->getFullCart())){
                ...
                // Supprimer la session en cours du panier
